                    ...
                    <div className="form-sec">
                      <form action="" className="theme-form">
                        <div className="form-group">
                          ...
                          <input type={"email"} id="email" className="form-control" placeholder="please writre you email"  />
                        </div>
                        <div className="form-group">
                          <label htmlFor="password">Password</label>
                          <input type={isShow ? "text":"password"} id="name" className="form-control" placeholder="please right you name"  />
